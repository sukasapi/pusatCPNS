                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="info-footer">
                            <div class="info__logo">
                                <img src="<?php echo base_url('assets/fe/'); ?>images/flogo.png" alt="footer logo">
                            </div>
                            ...
                            <ul class="info-contact">
                                ...
                                <li>
                                    ...
                                    <span class="info">support@pusatCPNS.com</span>
                                </li>
                                <li>
                                    <span class="lnr lnr-map-marker info-icon"></span>
                                    <span class="info">Almaatnya di Jogja</span>
                                </li>
                            </ul>
                        </div>
                        <!-- end /.info-footer -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="copyright-text">
                            <p>&copy; 2021
                                <a href="#">mini<strong>BITE</strong></a>. All rights reserved. Created by
                                <a href="#">Sukasapi</a>
                            </p>
                        </div>
