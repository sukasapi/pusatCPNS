...
class Login extends CI_Controller
{
    ...
    public function loginow()
    {
        ...
        {
            $email = strtolower($this->security->xss_clean($this->input->post('input')));
    ...
    public function forgotPassword()
    {
        ...
        if(!isset($isLoggedIn) || $isLoggedIn != TRUE)
        {
            $this->load->view('be/forgotPassword');
        }
        else
        {
            redirect('/dashboard');
    ...
    function resetPasswordConfirmUser($activation_id, $email)
    {
        ...
        if ($is_correct == 1)
        {
            $this->load->view('be/newPassword', $data);
        }
        else
        {
            redirect('/login');
